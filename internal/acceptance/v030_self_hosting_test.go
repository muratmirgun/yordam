...
func selfHostSuccessSteps(readmeSHA string) []providerStep {
	...
	return []providerStep{
		...
		{Role: "child", RequiredTools: childTools, RequiredText: []string{"child-search-heading", readmeSHA}, SSE: providerToolCallSSE("child-edit-heading", "edit", fmt.Sprintf(`{"path":"README.md","expected_sha256":%q,"replacements":[{"old":"# Yordam\n","new":"# Yordam self-hosted\n"}]}`, readmeSHA))},
